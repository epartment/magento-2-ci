...
* "ReadableStream is not defined". 24 is the last major that runs below
* Node 22.12, and it runs on Node 16 too although its engines field says >= 18
* (verified up to 24.43.1). Do not go below 24: Puppeteer 21 rejects the bare
* "puppeteer browsers install" that pipelines generated by epartment/deployer
* before 1.7.2 still run. Every value in NODE_VERSIONS and
